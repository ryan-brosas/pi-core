...
import { ICON_OPACITY, BRAIN_RIGHT_PATHS, BRAIN_LEFT_PATHS } from "./shared";

export function AnimatedBrain({ hovered }: { hovered: boolean }) {
  ...
  return (
    <motion.div animate={scaleCtrl}>
      <svg
        ...
        style={{ color: "var(--color-fg)", opacity: ICON_OPACITY, overflow: "visible" }}
      >
